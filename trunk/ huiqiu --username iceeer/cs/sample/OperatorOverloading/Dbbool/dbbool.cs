...
class Test
{
    static void Main()
    {
        ...
        if ((bool)a)//explicit operator bool
            Console.WriteLine("b is definitely true");
        else
            Console.WriteLine("b is not definitely true");

        if (c && a)//first operator false to c then operator true the result. because c is false, operator not do with c.
            Console.WriteLine("c && a is definitely true");
        else
            Console.WriteLine("c && a is definitely false");

        if (a || c)//first operator true to c then operator true to the result. because a is true, operator not do with a.
            Console.WriteLine("a || c is definitely true");
        else
            Console.WriteLine("a || c is not definitely true");
