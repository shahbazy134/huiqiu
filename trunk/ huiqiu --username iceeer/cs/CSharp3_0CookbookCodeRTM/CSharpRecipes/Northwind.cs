...
public partial class OrderDetails : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="Order Details_FK00", Storage="_Products", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
...
public partial class Orders : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="Orders_FK00", Storage="_Customers", ThisKey="CustomerID", OtherKey="CustomerID", IsForeignKey=true)]
	...
	[Association(Name="Orders_FK01", Storage="_Shippers", ThisKey="ShipVia", OtherKey="ShipperID", IsForeignKey=true)]
	...
	[Association(Name="Orders_FK02", Storage="_Employees", ThisKey="EmployeeID", OtherKey="EmployeeID", IsForeignKey=true)]
...
public partial class Products : INotifyPropertyChanging, INotifyPropertyChanged
{
	...
	[Association(Name="Products_FK00", Storage="_Suppliers", ThisKey="SupplierID", OtherKey="SupplierID", IsForeignKey=true)]
	...
	[Association(Name="Products_FK01", Storage="_Categories", ThisKey="CategoryID", OtherKey="CategoryID", IsForeignKey=true)]
